		...
		if ($files) {
			foreach ($files as $file) {
				...
				$store_data[] = array(
					...
					'status' => $this->config->get('analytics_' . $extension . '_status') ? $this->language->get('<i class="fa-sharp fa-solid fa-circle-check icon_active"></i>') : $this->language->get('text_disabled')
				);
				...
				$data['extensions'][] = array(
					...
					'icon'      => $this->language->get('extension')->get('text_icon'),
					'link'       => $link,
